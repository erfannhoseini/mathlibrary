...
Array.prototype.sliceShape=function(v1,v2,v3,v4) {
            ...
            if(cpa.length>3){
              for(let sg=0;sg<cpa.length-1;sg++){
                 ...
                 if( !(cpa[sg].p.x==cpa[sg+1].p.x&&cpa[sg].p.y==cpa[sg+1].p.y) ){
                   ...
                   let a1 =  angle(cpa[sg].l.x2 ,cpa[sg].l.y2,cpa[sg].l.x1,cpa[sg].l.y1);
                   ...
                   if ( !( (fixTodeg(a2-a1)<360 && fixTodeg(a2-a1)>180)  &&  (fixTodeg(a4-a3)<360 && fixTodeg(a4-a3)>180)  )  ) {
                     ...
                     if( (cpa[(sg+1)%cpa.length].p.x==cpa[(sg+2)%cpa.length].p.x&&cpa[(sg+1)%cpa.length].p.y==cpa[(sg+2)%cpa.length].p.y) ){
                       cpa.displacement((sg+1)%cpa.length,(sg+2)%cpa.length);
